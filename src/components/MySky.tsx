...
export function MySky({ overview, sunPosition }: { overview: SkyOverview; sunPosition?: SunPosition | null }) {
  return (
    <section className="flex flex-col gap-6 border border-rule p-5">
      ...
      <SunArc overview={overview} sunPosition={sunPosition ?? undefined} />
      <MoonGlyph
